...
rev(IdRev, IdAn, Note, timestamp, IdUsr)
    ...
    */
    ...
    public function selectActualOrg()
    {
        try {
            $Db = new DB();
    ...
    public function setOrgCodeParams($OrgCodeParams)
    {
...
$B = new B();
$Results = $B->selectActualOrg();
$Result_arr = mysqli_fetch_all($Results, MYSQLI_ASSOC);
