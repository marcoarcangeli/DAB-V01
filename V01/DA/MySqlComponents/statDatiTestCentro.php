...
class statDatiTestCentro 
{
    ...
    // object properties
    /*  
statDatiTestCentro(idstatDatiTestCentro, idStatDatiTest, note, aritmetica, geometrica
    */
    
    public $idstatDatiTestCentro;
    ...
    public function selectSingle()
    {
        ...
        try {
            ...
            FROM
                statDatiTestCentro t
            WHERE
                idstatDatiTestCentro = '"
                . $this->idstatDatiTestCentro
                . "'";
            // echo $query."\n";
            //throw new exception($query."\n");
            // prepare query statement
    ...
    public function insert()
    {
        try {
            ...
            //    return false;
            //}
            // statDatiTestCentro(t.idstatDatiTestCentro,t.idStatDatiTest,t.idStVar,t.note,
            // t.aritmetica,t.geometrica,t.quadratica,t.armonica,t.moda,t.mediana
            // query to insert record
            $query = "INSERT INTO  statDatiTestCentro
                        (idStatDatiTest, note, aritmetica, geometrica, quadratica, armonica, moda, mediana)
                  VALUES
            ...
            // execute query
            if ($Stmt) {
                $this->idstatDatiTestCentro = $this->conn->insert_id;
                return true;
            }
            return false;
        } catch (Exception $e) {
    ...
    public function update()
    {
        try {
            ...
            $query = "UPDATE
                ...
                WHERE
                    idstatDatiTestCentro = " . $this->idstatDatiTestCentro;
            // throw new exception($query."\n");
    ...
    public function delete()
    {
        try {
            ...
            $query = "DELETE from statDatiTestCentro 
                WHERE idstatDatiTestCentro = '" . $this->idstatDatiTestCentro . "'";
            //throw new exception($query."\n");
            // prepare query statement
            $Stmt = mysqli_query($this->conn, $query);
            //throw new exception("righe trovate ".$Stmt->num_rows."\n");
