...
class statDatiTrainVar 
{
    ...
    // object properties
    /*  
statDatiTrainVar(idStatDatiTrainVar, idStatDatiTrain, note, minimum, maximum
    */
    
    public $idStatDatiTrainVar;
    ...
    public function insert()
    {
        try {
            ...
            //    return false;
            //}
            // statDatiTrainVar(t.idStatDatiTrainVar,t.idStatDatiTrain,t.idStVar,t.note,
            // t.minimum,t.maximum,t.mean,t.sd,t.variance,t.varCoeff
            // query to insert record
            $query = "INSERT INTO  statDatiTrainVar
                        (idStatDatiTrain, note, minimum, maximum, mean, sd, variance, varCoeff)
                  VALUES
            ...
            // execute query
            if ($Stmt) {
                $this->idStatDatiTrainVar = $this->conn->insert_id;
                return true;
            }
            return false;
        } catch (Exception $e) {
    ...
    public function delete()
    {
        try {
            ...
            $query = "DELETE from statDatiTrainVar 
                WHERE idStatDatiTrainVar = '" . $this->idStatDatiTrainVar . "'";
            //throw new exception($query."\n");
            // prepare query statement
            $Stmt = mysqli_query($this->conn, $query);
            //throw new exception("righe trovate ".$Stmt->num_rows."\n");
