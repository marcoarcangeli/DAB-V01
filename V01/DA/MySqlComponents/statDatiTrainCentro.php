...
class statDatiTrainCentro 
{
    ...
    // object properties
    /*  
statDatiTrainCentro(idstatDatiTrainCentro, idStatDatiTrain, note, aritmetica, geometrica
    */
    
    public $idstatDatiTrainCentro;
    ...
    public function selectSingle()
    {
        ...
        try {
            ...
            FROM
                statDatiTrainCentro t
            WHERE
                idstatDatiTrainCentro = '"
                . $this->idstatDatiTrainCentro
                . "'";
            // echo $query."\n";
            //throw new exception($query."\n");
            // prepare query statement
    ...
    public function insert()
    {
        try {
            ...
            //    return false;
            //}
            // statDatiTrainCentro(t.idstatDatiTrainCentro,t.idStatDatiTrain,t.idStVar,t.note,
            // t.aritmetica,t.geometrica,t.quadratica,t.armonica,t.moda,t.mediana
            // query to insert record
            $query = "INSERT INTO  statDatiTrainCentro
                        (idStatDatiTrain, note, aritmetica, geometrica, quadratica, armonica, moda, mediana)
                  VALUES
            ...
            // execute query
            if ($Stmt) {
                $this->idstatDatiTrainCentro = $this->conn->insert_id;
                return true;
            }
            return false;
        } catch (Exception $e) {
    ...
    public function update()
    {
        try {
            ...
            $query = "UPDATE
                ...
                WHERE
                    idstatDatiTrainCentro = " . $this->idstatDatiTrainCentro;
            // throw new exception($query."\n");
    ...
    public function delete()
    {
        try {
            ...
            $query = "DELETE from statDatiTrainCentro 
                WHERE idstatDatiTrainCentro = '" . $this->idstatDatiTrainCentro . "'";
            //throw new exception($query."\n");
            // prepare query statement
            $Stmt = mysqli_query($this->conn, $query);
            //throw new exception("righe trovate ".$Stmt->num_rows."\n");
