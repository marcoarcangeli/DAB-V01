...
class statRisTest 
{
    ...
    // object properties
    /*  
statRisTest(idStatRisTest, idTest, note, nDimensioni, nMisure
    */
    ...
    public function insert()
    {
        try {
            ...
            //    return false;
            //}
            // statRisTest(idStatRisTest, idTest, note, nDimensioni
            // query to insert record
            $query = "INSERT INTO  statRisTest
            ...
            // execute query
            if ($Stmt) {
                $this->idStatRisTest = $this->conn->insert_id;
                return true;
            }
            return false;
        } catch (Exception $e) {
    ...
    public function update()
    {
        try {
            ...
            $query = "UPDATE
                ...
                WHERE
                    idStatRisTest = " . $this->idStatRisTest;
            // if($_SESSION["Debug"]>=2){ LM::LogMessage("DEBUG",__CLASS__."->". __FUNCTION__." - query: ".$query); }
    ...
    public function delete()
    {
        try {
            ...
            $query = "DELETE from statRisTest 
                WHERE idStatRisTest = '" . $this->idStatRisTest . "'";
            //throw new exception($query."\n");
            // prepare query statement
            $Stmt = mysqli_query($this->conn, $query);
            //throw new exception("righe trovate ".$Stmt->num_rows."\n");
