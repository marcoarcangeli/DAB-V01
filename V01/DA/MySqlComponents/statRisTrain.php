...
class statRisTrain 
{
    ...
    // object properties
    /*  
statRisTrain(idStatRisTrain, IdTrain, note, nDimensioni, nMisure
    */
    ...
    public function insert()
    {
        try {
            ...
            //    return false;
            //}
            // statRisTrain(idStatRisTrain, IdTrain, note, nDimensioni
            // query to insert record
            $query = "INSERT INTO  statRisTrain
            ...
            // execute query
            if ($Stmt) {
                $this->idStatRisTrain = $this->conn->insert_id;
                return true;
            }
            return false;
        } catch (Exception $e) {
    ...
    public function update()
    {
        try {
            ...
            $query = "UPDATE
                ...
                WHERE
                    idStatRisTrain = " . $this->idStatRisTrain;
            // if($_SESSION["Debug"]>=2){ LM::LogMessage("DEBUG",__CLASS__."->". __FUNCTION__." - query: ".$query); }
    ...
    public function delete()
    {
        try {
            ...
            $query = "DELETE from statRisTrain 
                WHERE idStatRisTrain = '" . $this->idStatRisTrain . "'";
            //throw new exception($query."\n");
            // prepare query statement
            $Stmt = mysqli_query($this->conn, $query);
            //throw new exception("righe trovate ".$Stmt->num_rows."\n");
