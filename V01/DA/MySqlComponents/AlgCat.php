...
class AlgCat
{
    ...
    // object properties
    /*  
AlgCat(IdAlgCat, Nam, Descr, timestamp, IdUsr)
    */
    public $IdAlgCat;
    public $IdAlgCatPar;
    public $Nam;
    ...
    */
    ...
    public function insert()
    {
        try {
            ...
            $query = "INSERT INTO  AlgCat
                        (IdAlgCatPar, Nam, Descr)
                  VALUES
                        (
                         " . VN($this->IdAlgCatPar) . ",
                         " . VN($this->Nam) . ",
            ...
            // execute query
            if ($Stmt) {
                $this->IdAlgCat = $this->conn->insert_id;
                return true;
            }
            return false;
        } catch (Exception $e) {
    ...
    public function update()
    {
        try {
            ...
            $query = "UPDATE
                    AlgCat
                SET
                    IdAlgCatPar="   .VN($this->IdAlgCatPar) . ",
                    Nam="           .VN($this->Nam) . ",
                    Descr="         .VN($this->Descr) . "
                WHERE
                    IdAlgCat='" . $this->IdAlgCat . "'";
            // throw new exception($query."\n");
    ...
    public function delete()
    {
        try {
            ...
            $query = "DELETE from AlgCat 
                WHERE IdAlgCat = '" . $this->IdAlgCat . "'";
            //throw new exception($query."\n");
            // prepare query statement
            $Stmt = mysqli_query($this->conn, $query);
            //throw new exception("righe trovate ".$Stmt->num_rows."\n");
