...
class statRisTrainCentro 
{
    ...
    // object properties
    /*  
StatRisTrainCentro(idStatRisTrainCentro, idStatRisTrain, note, aritmetica, geometrica
    */
    
    public $idStatRisTrainCentro;
    ...
    public function selectSingle()
    {
        ...
        try {
            ...
            FROM
                StatRisTrainCentro t
            WHERE
                idStatRisTrainCentro = '"
                . $this->idStatRisTrainCentro
                . "'";
            // echo $query."\n";
            //throw new exception($query."\n");
            // prepare query statement
    ...
    public function insert()
    {
        try {
            ...
            //    return false;
            //}
            // StatRisTrainCentro(t.idStatRisTrainCentro,t.idStatRisTrain,t.idStVar,t.note,
            // t.aritmetica,t.geometrica,t.quadratica,t.armonica,t.moda,t.mediana
            // query to insert record
            $query = "INSERT INTO  StatRisTrainCentro
                        (idStatRisTrain, note, aritmetica, geometrica, quadratica, armonica, moda, mediana)
                  VALUES
            ...
            // execute query
            if ($Stmt) {
                $this->idStatRisTrainCentro = $this->conn->insert_id;
                return true;
            }
            return false;
        } catch (Exception $e) {
    ...
    public function update()
    {
        try {
            ...
            $query = "UPDATE
                ...
                WHERE
                    idStatRisTrainCentro = " . $this->idStatRisTrainCentro;
            // if($_SESSION["Debug"]>=2){ LM::LogMessage("DEBUG",__CLASS__."->". __FUNCTION__." - query: ".$query); }
    ...
    public function delete()
    {
        try {
            ...
            $query = "DELETE from StatRisTrainCentro 
                WHERE idStatRisTrainCentro = '" . $this->idStatRisTrainCentro . "'";
            //throw new exception($query."\n");
            // prepare query statement
            $Stmt = mysqli_query($this->conn, $query);
            //throw new exception("righe trovate ".$Stmt->num_rows."\n");
