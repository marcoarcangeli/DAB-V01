...
class statRisTestAsim 
{
    ...
    // object properties
    /*  
StatRisTestAsim(idStatRisTestAsim, idStatRisTest, note, mediaModa, coefPearson1
    */
    
    public $idStatRisTestAsim;
    ...
    public function insert()
    {
        try {
            ...
            //    return false;
            //}
            // StatRisTestAsim(t.idStatRisTestAsim,t.idStatRisTest,t.idStVar,t.note,
            // t.mediaModa,t.coefPearson1,t.coefPearson2,t.armonica,t.moda,t.mediana
            // query to insert record
            $query = "INSERT INTO  StatRisTestAsim
                        (idStatRisTest, note, mediaModa, coefPearson1, coefPearson2)
                  VALUES
            ...
            // execute query
            if ($Stmt) {
                $this->idStatRisTestAsim = $this->conn->insert_id;
                return true;
            }
            return false;
        } catch (Exception $e) {
    ...
    public function update()
    {
        try {
            ...
            $query = "UPDATE
                ...
                WHERE
                    idStatRisTestAsim = " . $this->idStatRisTestAsim;
            // if($_SESSION["Debug"]>=2){ LM::LogMessage("DEBUG",__CLASS__."->". __FUNCTION__." - query: ".$query); }
    ...
    public function delete()
    {
        try {
            ...
            $query = "DELETE from StatRisTestAsim 
                WHERE idStatRisTestAsim = '" . $this->idStatRisTestAsim . "'";
            //throw new exception($query."\n");
            // prepare query statement
            $Stmt = mysqli_query($this->conn, $query);
            //throw new exception("righe trovate ".$Stmt->num_rows."\n");
