...
class RColType
{
    ...
    // object properties
    /*  
    IdRColType int not null primary key auto_increment,
    ...
    */
    ...
    public function insert()
    {
        try {
            ...
            // execute query
            if ($Stmt) {
                $this->IdRColType = $this->conn->insert_id;
                return true;
            }
            return false;
        } catch (Exception $e) {
    ...
    public function delete()
    {
        try {
            ...
            $query = "DELETE from RColType 
                WHERE IdRColType = '" . $this->IdRColType . "'";
            //throw new exception($query."\n");
            // prepare query statement
            $Stmt = mysqli_query($this->conn, $query);
            //throw new exception("righe trovate ".$Stmt->num_rows."\n");
