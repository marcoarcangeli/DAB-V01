<?php
namespace DA\HtmlComponents\AlgCat;

$BFD=$_SESSION["BaseFolderDyn"];
// include Database and object files 
include_once($BFD.'DA/mySqlComponents/Database.php');
include_once($BFD.'DA/mySqlComponents/AlgCat.php');
...
use DA\mySqlComponents\AlgCat as DAO;

class DaoCtrl
{
    // common params with deafaults;
    public string $CompulsoryParamNams = 'IdAlgCat';
    public string $OptionalParamNams = '';
    // public string $ParamSource = 'PSV';
    // public string $ParamSource2 = 'ASV';
    // public string $SaveParamNams = "IdAlgCat,IdAlgCatPar,Nam,Descr";
    ...
    {
        $CompulsoryParamNams = $this->CompulsoryParamNams; //"IdAlgCat";
        try {
            // get Database connection
            $Db = new DB();
            $Db = $Db->getConnection();
    ...
    public function SaveDb(array $Params)
    {
        ...
        // $SaveParamNams = $this->SaveParamNams; //"IdAn,IdPrj,IdAlgCat,IdAnState,Nam,Descr,Dttm";
