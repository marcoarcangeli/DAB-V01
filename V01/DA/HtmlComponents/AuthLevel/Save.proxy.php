...
include_once($BFD.'DA/HtmlComponents/AuthLevel/Dao.ctrl.php');
include_once($BFD.'DA/Logs/LogManager.php');

use DA\Logs\LogManager as LM;
use DA\HtmlComponents\AuthLevel\DaoCtrl as DAO;

// $CompulsoryParamSources = "_GET"; // next version
$CompulsoryParamNams = "IdAuthLevel";
$SaveParamNams="IdAuthLevel,Nam,Descr,AuthLevel";
try {
    // prepare params
