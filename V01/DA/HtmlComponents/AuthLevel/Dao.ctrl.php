<?php
namespace DA\HtmlComponents\AuthLevel;

$BFD=$_SESSION["BaseFolderDyn"];
// include Database and object files 
include_once($BFD.'DA/mySqlComponents/Database.php');
include_once($BFD.'DA/mySqlComponents/AuthLevel.php');
...
use DA\mySqlComponents\AuthLevel as DAO;

class DaoCtrl
{
    // common params with deafaults;
    public string $CompulsoryParamNams = 'IdAuthLevel';
    public string $OptionalParamNams = ''; //'SearchIds';
    // public string $ParamSource = 'PSV';
    // public string $ParamSource2 = 'ASV';
    // public string $SaveParamNams = "IdAuthLevel,IdAuthLevelState,IdAuthLevelCat,Nam,Descr,fileRefProc,CatTag";
    ...
    {
        $CompulsoryParamNams = $this->CompulsoryParamNams; //"IdAuthLevel";
        try {
            // get Database connection
            $Db = new DB();
            $Db = $Db->getConnection();
