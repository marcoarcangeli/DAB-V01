...
include_once($BFD.'DA/HtmlComponents/StVarCat/Dao.ctrl.php');
include_once($BFD.'DA/Logs/LogManager.php');

use DA\Logs\LogManager as LM;
use DA\HtmlComponents\StVarCat\DaoCtrl as DAO;

// $CompulsoryParamSources = "_GET"; // next version
$CompulsoryParamNams = "IdStVarCat";
$SaveParamNams = "IdStVarCat,IdStVarCatPar,Nam,Descr";
try {
    // prepare params
    $Params = array();
