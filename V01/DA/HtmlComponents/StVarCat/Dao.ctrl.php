<?php
namespace DA\HtmlComponents\StVarCat;

$BFD=$_SESSION["BaseFolderDyn"];
// include Database and object files 
include_once($BFD.'DA/mySqlComponents/Database.php');
include_once($BFD.'DA/mySqlComponents/StVarCat.php');
...
use DA\mySqlComponents\StVarCat as DAO;

class DaoCtrl
{
    // common params with deafaults;
    public string $CompulsoryParamNams = 'IdStVarCat';
    public string $OptionalParamNams = '';
    // public string $ParamSource = 'PSV';
    // public string $ParamSource2 = 'ASV';
    // public string $SaveParamNams = "IdStVarCat,IdStVarCatPar,Nam,Descr";
    ...
    {
        $CompulsoryParamNams = $this->CompulsoryParamNams; //"IdStVarCat";
        try {
            // get Database connection
            $Db = new DB();
            $Db = $Db->getConnection();
    ...
    public function SaveDb(array $Params)
    {
        ...
        // $SaveParamNams = $this->SaveParamNams; //"IdAn,IdPrj,IdStVarCat,IdAnState,Nam,Descr,Dttm";
