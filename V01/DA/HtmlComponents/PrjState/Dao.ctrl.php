<?php
namespace DA\HtmlComponents\PrjState;

$BFD=$_SESSION["BaseFolderDyn"];
// include Database and object files 
include_once($BFD.'DA/mySqlComponents/Database.php');
include_once($BFD.'DA/mySqlComponents/PrjState.php');
...
use DA\mySqlComponents\PrjState as DAO;

class DaoCtrl
{
    // common params with deafaults;
    public string $CompulsoryParamNams = 'IdPrjState';
    public string $OptionalParamNams = ''; //'SearchIds';
    // public string $ParamSource = 'PSV';
    // public string $ParamSource2 = 'ASV';
    // public string $SaveParamNams = "IdPrjState,IdPrjStateState,IdPrjStateCat,Nam,Descr,fileRefProc,CatTag";
    ...
    {
        $CompulsoryParamNams = $this->CompulsoryParamNams; //"IdPrjState";
        try {
            // get Database connection
            $Db = new DB();
            $Db = $Db->getConnection();
