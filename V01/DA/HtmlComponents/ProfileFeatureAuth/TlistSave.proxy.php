...
$CompulsoryParamNams = "ProfileFeatureAuths";
$SaveParamNams="ProfileFeatureAuths";
try {
    // prepare params
    ...
    if($_SESSION["Debug"]>=2){ LM::LogMessage("DEBUG", "TlistSave.proxy.php - json_encode(Params[".$CompulsoryParamNams."]): ".json_encode($Params[$CompulsoryParamNams])); }
    ...
    $Result_arr = $Dao->TlistSaveDb($Params);
