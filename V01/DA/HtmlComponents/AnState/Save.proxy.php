...
include_once($BFD.'DA/HtmlComponents/AnState/Dao.ctrl.php');
include_once($BFD.'DA/Logs/LogManager.php');

use DA\Logs\LogManager as LM;
use DA\HtmlComponents\AnState\DaoCtrl as DAO;

// $CompulsoryParamSources = "_GET"; // next version
$CompulsoryParamNams = "IdAnState";
$SaveParamNams="IdAnState,Nam,Descr";
try {
    // prepare params
