...
include_once($BFD.'DA/HtmlComponents/AlgParamType/Dao.ctrl.php');
include_once($BFD.'DA/Logs/LogManager.php');

use DA\Logs\LogManager as LM;
use DA\HtmlComponents\AlgParamType\DaoCtrl as DAO;

// $CompulsoryParamSources = "_GET"; // next version
$CompulsoryParamNams = "IdAlgParamType";
$SaveParamNams="IdAlgParamType,IdParamType,IdAlg,Nam,Descr,vlDefault";
try {
    // prepare params
