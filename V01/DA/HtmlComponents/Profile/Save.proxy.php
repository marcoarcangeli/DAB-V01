...
include_once($BFD.'DA/HtmlComponents/Profile/Dao.ctrl.php');
include_once($BFD.'DA/Logs/LogManager.php');

use DA\Logs\LogManager as LM;
use DA\HtmlComponents\Profile\DaoCtrl as DAO;

// $CompulsoryParamSources = "_GET"; // next version
$CompulsoryParamNams = "IdProfile";
$SaveParamNams="IdProfile,Nam,Descr";
try {
    // prepare params
