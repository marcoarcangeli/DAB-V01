<?php
namespace DA\HtmlComponents\FeatureCat;

$BFD=$_SESSION["BaseFolderDyn"];
// include Database and object files 
include_once($BFD.'DA/mySqlComponents/Database.php');
include_once($BFD.'DA/mySqlComponents/FeatureCat.php');
...
use DA\mySqlComponents\FeatureCat as DAO;

class DaoCtrl
{
    // common params with deafaults;
    public string $CompulsoryParamNams = 'IdFeatureCat';
    public string $OptionalParamNams = '';
    // public string $ParamSource = 'PSV';
    // public string $ParamSource2 = 'ASV';
    // public string $SaveParamNams = "IdFeatureCat,IdFeatureCatPar,Nam,Descr";
    ...
    {
        $CompulsoryParamNams = $this->CompulsoryParamNams; //"IdFeatureCat";
        try {
            // get Database connection
            $Db = new DB();
            $Db = $Db->getConnection();
    ...
    public function SaveDb(array $Params)
    {
        ...
        // $SaveParamNams = $this->SaveParamNams; //"IdAn,IdPrj,IdFeatureCat,IdAnState,Nam,Descr,Dttm";
