...
class GridAccordion2D implements IHJC
{
    ...
    public function __construct(string $Param = "OK")    {
        ...
        //     foreach ($Row as $Field) {
                ...
                //     $classe=$Field;
                // } else {
                //     $classe=$_SESSION["ToDoClass"];
                // }

        //         include_once($classe . '.php');
        //         $Obj = new $classe($this->ObjsHeader2[$i][$j]);
    ...
    protected function BuildHtml(string $ClassName)
    {
        try {
            ...
            include($_SESSION["ContentCodePath"] . "GridAccordion2D.html.php"); // Include your template.
            // ob_clean ();
