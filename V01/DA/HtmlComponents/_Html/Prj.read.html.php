    ...
    <div class="card <?php echo $this->Col_H; ?>">
        ...
        <div class="card-body ">
            ...
            <form role="form" method="POST">
                <div id="PrjBtns" class="row">
                    <button id="btnOpen" type="button" class="btn btn-outline-success btn-xs daBtnTool"
                        data-toggle="tooltip" data-placement="bottom" title="Open" value="Open" disabled><i
