    ...
    <div class="card <?php echo $this->Col_H; ?>">
        ...
        <div class="card-body">
            ...
            <form role="form" method="POST">
                <div id="EvntStructBtns" class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <!-- <div class="custom-control custom-checkbox">
                                <input class="custom-control-input" type="checkbox" id="EvntStruct_enum" value="">
                                <label for="EvntStruct_enum" class="custom-control-label">Enum</label>
                            </div> -->
                            <div id="EvntStructTlist">

                            </div>
                        </div>
                        <!-- <table id="EvntFileDatList" class="table table-bordered table-hover display"> -->
                        <!-- <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Name</th>
