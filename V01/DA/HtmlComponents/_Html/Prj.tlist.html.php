            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <button id="btnRefreshUsrs" type="button" class="btn btn-outline-primary btn-xs">Update</button> -->
                    </div>
                    <div class="box-body">
                        <table id="PrjList" class="table table-bordered table-hover display">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Name</th>
