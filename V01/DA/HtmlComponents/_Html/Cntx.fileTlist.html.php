    ...
    <div class="card <?php echo $this->Col_H; ?>">
        ...
        <div class="card-body">
            ...
            <div class="col-md-12">
                ...
                <div class="card <?php echo $this->Col_H; ?>">
                    <div id="Cntx_FileTlistBtns" class="row">
                        <?php include($_SESSION["ContentCommonRelPath"].$_SESSION["btnToolboxFileTlistHtml"]); ?>
                    </div>
                </div>
                <div id="Cntx_FileTlist_UploadFiles" class="daHidden">
                ...
                <div id="Cntx_FileTlist_DropFiles" class="form-group">
                    <div class="btn btn-outline-primary btn-xs daDropFilesArea" id="dropFiles">
                        Click or Drop Here
                    </div>
                </div>
                <div class="card-body">
                    <table id="CntxList" class="table table-bordered table-hover display">
                        <thead>
                            <tr>
                                <th>File Nam</th>
                            </tr>
                ...
                <div class="box-footer">
                    ...
                    <input id="Cntx_SelectedFile" type="hidden" name="Cntx_Cntx_SelectedFile" value="">
                </div>
                <!-- </div> -->
                <!-- /div -->
            </div>
