...
include_once($BFD.'DA/HtmlComponents/Usr/Dao.ctrl.php');
include_once($BFD.'DA/Logs/LogManager.php');

use DA\Logs\LogManager as LM;
use DA\HtmlComponents\Usr\DaoCtrl as DAO;

// $CompulsoryParamSources = "_GET"; // next version
$CompulsoryParamNams = "IdUsr";
$SaveParamNams="IdUsr,UsrNam,Pwd,FirstNam,Nam,EMail,IdOrganization";
try {
    // prepare params
