<?php
namespace DA\HtmlComponents\Usr;

$BFD=$_SESSION["BaseFolderDyn"];
// include Database and object files 
include_once($BFD.'DA/mySqlComponents/Database.php');
include_once($BFD.'DA/mySqlComponents/Usr.php');
...
use DA\mySqlComponents\Usr as DAO;
...
class DaoCtrl
{
    ...
    // public string $SaveParamNams = "IdUsr,IdUsrState,IdUsrCat,Nam,Descr,fileRefProc,CatTag";
