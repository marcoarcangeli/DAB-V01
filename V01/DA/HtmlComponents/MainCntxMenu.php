...
class MainCntxMenu implements IHJC
{
  ...
  protected function BuildHtml(string $Param)
  {
    try {
      ...
      include($_SESSION["ContentCodePath"] . "MainCntxMenu.html.php"); // Include your template.
  ...
  protected function BuildJs(string $Param)
  {
    ...
    try {
      ...
      include($_SESSION["ContentCodePath"] . "MainCntxMenu.js.php"); // Include your template.
