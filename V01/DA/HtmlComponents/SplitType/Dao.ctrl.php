...
include_once($BFD.'DA/mySqlComponents/SplitType.php');
...
use DA\mySqlComponents\SplitType as DAO;

class DaoCtrl
{
    // common params with deafaults;
    public string $CompulsoryParamNams = 'IdSplitType';
    public string $OptionalParamNams = ''; //'SearchIds';
    // public string $ParamSource = 'PSV';
    // public string $ParamSource2 = 'ASV';
    // public string $SaveParamNams = "IdSplitType,IdSplitTypeState,IdSplitTypeCat,Nam,Descr,fileRefProc,CatTag";
    ...
    {
        $CompulsoryParamNams = $this->CompulsoryParamNams; //"IdSplitType";
        try {
            // get Database connection
            $Db = new DB();
            $Db = $Db->getConnection();
