...
include_once($BFD.'DA/HtmlComponents/SplitType/Dao.ctrl.php');
include_once($BFD.'DA/Logs/LogManager.php');

use DA\Logs\LogManager as LM;
use DA\HtmlComponents\SplitType\DaoCtrl as DAO;

// $CompulsoryParamSources = "_GET"; // next version
$CompulsoryParamNams = "IdSplitType";
$SaveParamNams="IdSplitType,IdSplitTypeCat,Nam,Descr,Perc";
try {
    // prepare params
