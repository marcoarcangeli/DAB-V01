...
include_once($BFD.'DA/mySqlComponents/ParamType.php');
...
use DA\mySqlComponents\ParamType as DAO;

class DaoCtrl
{
    // common params with deafaults;
    public string $CompulsoryParamNams = 'IdParamType';
    public string $OptionalParamNams = ''; //'SearchIds';
    // public string $ParamSource = 'PSV';
    // public string $ParamSource2 = 'ASV';
    // public string $SaveParamNams = "IdParamType,IdParamTypeState,IdParamTypeCat,Nam,Descr,fileRefProc,CatTag";
    ...
    {
        $CompulsoryParamNams = $this->CompulsoryParamNams; //"IdParamType";
        try {
            // get Database connection
            $Db = new DB();
            $Db = $Db->getConnection();
