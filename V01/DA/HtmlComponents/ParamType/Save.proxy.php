...
include_once($BFD.'DA/HtmlComponents/ParamType/Dao.ctrl.php');
include_once($BFD.'DA/Logs/LogManager.php');

use DA\Logs\LogManager as LM;
use DA\HtmlComponents\ParamType\DaoCtrl as DAO;

// $CompulsoryParamSources = "_GET"; // next version
$CompulsoryParamNams = "IdParamType";
$SaveParamNams="IdParamType,IdParamTypeCat,Nam,Descr,Unit,vlDefault";
try {
    // prepare params
