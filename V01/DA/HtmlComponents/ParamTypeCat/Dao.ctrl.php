<?php
namespace DA\HtmlComponents\ParamTypeCat;

$BFD=$_SESSION["BaseFolderDyn"];
// include Database and object files 
include_once($BFD.'DA/mySqlComponents/Database.php');
include_once($BFD.'DA/mySqlComponents/ParamTypeCat.php');
...
use DA\mySqlComponents\ParamTypeCat as DAO;

class DaoCtrl
{
    // common params with deafaults;
    public string $CompulsoryParamNams = 'IdParamTypeCat';
    public string $OptionalParamNams = '';
    // public string $ParamSource = 'PSV';
    // public string $ParamSource2 = 'ASV';
    // public string $SaveParamNams = "IdParamTypeCat,IdParamTypeCatPar,Nam,Descr";
    ...
    {
        $CompulsoryParamNams = $this->CompulsoryParamNams; //"IdParamTypeCat";
        try {
            // get Database connection
            $Db = new DB();
            $Db = $Db->getConnection();
    ...
    public function SaveDb(array $Params)
    {
        ...
        // $SaveParamNams = $this->SaveParamNams; //"IdAn,IdPrj,IdParamTypeCat,IdAnState,Nam,Descr,Dttm";
    ...
    public function TreeDb(array $Params)
    {
        $OptionalParamNams = $this->OptionalParamNams; //"SearchIds";
        // $CompulsoryParamNams = $this->CompulsoryParamNams; //"SearchIds";
        try {
