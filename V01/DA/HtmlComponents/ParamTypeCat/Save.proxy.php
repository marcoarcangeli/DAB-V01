...
include_once($BFD.'DA/HtmlComponents/ParamTypeCat/Dao.ctrl.php');
include_once($BFD.'DA/Logs/LogManager.php');

use DA\Logs\LogManager as LM;
use DA\HtmlComponents\ParamTypeCat\DaoCtrl as DAO;

// $CompulsoryParamSources = "_GET"; // next version
$CompulsoryParamNams = "IdParamTypeCat";
$SaveParamNams="IdParamTypeCat,IdParamTypeCatPar,Nam,Descr";
try {
    // prepare params
