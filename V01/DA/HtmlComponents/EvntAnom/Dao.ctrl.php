<?php
namespace DA\HtmlComponents\EvntAnom;

$BFD=$_SESSION["BaseFolderDyn"];
// include Database and object files 
// include_once($BFD.'DA/mySqlComponents/Database.php');
// include_once($BFD.'DA/mySqlComponents/EvntAnom.php');
...
// use DA\mySqlComponents\EvntAnom as DAO;

class DaoCtrl
{
    // common params with deafaults;
    // public string $CompulsoryParamNams = 'IdEvntAnom';
    // public string $OptionalParamNams = ''; //'SearchIds';
    // public string $ParamSource = 'PSV';
    // public string $ParamSource2 = 'ASV';
    // public string $SaveParamNams = "IdEvntAnom,IdEvntAnomState,IdEvntAnomCat,Nam,Descr,fileRefProc,CatTag";
    ...
    public function FileTlistFs(array $Params)
    {
        ...
        try {
            ...
            // $EvntAnom->idPrj = $_POST['idPrj'];
            // get manager object
            $Dir  = $_SESSION["PrjAbsPath"].$_SESSION["PSV"]["PrjFolderNam"].'/'.$_SESSION["PSV"]["EvntFolderNam"].'/';
