...
include_once($BFD.'DA/HtmlComponents/Alg/Dao.ctrl.php');
include_once($BFD.'DA/Logs/LogManager.php');

use DA\Logs\LogManager as LM;
use DA\HtmlComponents\Alg\DaoCtrl as DAO;

// $CompulsoryParamSources = "_POST";  // next version: eval + multivalue
$CompulsoryParamNams = "IdAlg";     // next version: multivalue
$SaveParamNams="IdAlg,IdAlgState,IdAlgCat,Nam,Descr,fileRefProc,CatTag";
try {
    // prepare params
