...
include_once($BFD.'DA/HtmlComponents/RColType/Dao.ctrl.php');
include_once($BFD.'DA/Logs/LogManager.php');

use DA\Logs\LogManager as LM;
use DA\HtmlComponents\RColType\DaoCtrl as DAO;

// $CompulsoryParamSources = "_GET"; // next version
$CompulsoryParamNams = "IdRColType";
$ParamNams="IdRColType,Nam,Descr";
try {
    // prepare params
    $Params = array();
