<?php
namespace DA\HtmlComponents\SplitCat;

$BFD=$_SESSION["BaseFolderDyn"];
// include Database and object files 
include_once($BFD.'DA/mySqlComponents/Database.php');
include_once($BFD.'DA/mySqlComponents/SplitCat.php');
...
use DA\mySqlComponents\SplitCat as DAO;

class DaoCtrl
{
    // common params with deafaults;
    public string $CompulsoryParamNams = 'IdSplitCat';
    public string $OptionalParamNams = '';
    // public string $ParamSource = 'PSV';
    // public string $ParamSource2 = 'ASV';
    // public string $SaveParamNams = "IdSplitCat,IdSplitCatPar,Nam,Descr";
    ...
    {
        $CompulsoryParamNams = $this->CompulsoryParamNams; //"IdSplitCat";
        try {
            // get Database connection
            $Db = new DB();
            $Db = $Db->getConnection();
    ...
    public function SaveDb(array $Params)
    {
        ...
        // $SaveParamNams = $this->SaveParamNams; //"IdAn,IdPrj,IdSplitCat,IdAnState,Nam,Descr,Dttm";
