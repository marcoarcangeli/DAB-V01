...
// include_once($BFD.'DA/mySqlComponents/EvntStats.php');
...
// use DA\mySqlComponents\EvntStats as DAO;

class DaoCtrl
{
    // common params with deafaults;
    // public string $CompulsoryParamNams = 'IdEvntStats';
    // public string $OptionalParamNams = ''; //'SearchIds';
    // public string $ParamSource = 'PSV';
    // public string $ParamSource2 = 'ASV';
    // public string $SaveParamNams = "IdEvntStats,IdEvntStatsState,IdEvntStatsCat,Nam,Descr,fileRefProc,CatTag";
