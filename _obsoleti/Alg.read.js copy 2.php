...
<?php echo $this->JSPanelNamSpace; ?> = {
                    ...
                    success: function(result) {
                        ...
                        if (result["State"]) {
                            ...
                            if (<?php echo $this->JSPanelNamSpace; ?>.RefPanels && <?php echo $this->JSPanelNamSpace; ?>.RefPanels != "") {
                                ...
                                da.RefreshDetailPanels(<?php echo $this->JSPanelNamSpace; ?>.RefPanels, "CleanAlg");
                            }
    ...
    Save: function() {
        try {
            // alert("#btnSaveAlg");
            if (da.verifyCompulsoryFields(<?php echo $this->JSPanelNamSpace; ?>.CompulsoryFields, '<?php echo $this->PanelTag; ?>')) {
                return $.ajax({
                    type: "POST",
                    ...
                    success: function(result) {
                        if (result["State"]) {
                            $("#<?php echo $this->PanelTag; ?>IdAlg").val(<?php echo $this->JSPanelNamSpace; ?>.IdAlg = result["IdAlg"])
                            <?php echo $this->JSPanelNamSpace; ?>.btnControl();
                            if (<?php echo $this->JSPanelNamSpace; ?>.ParentObj) {
                            ...
                            if (<?php echo $this->JSPanelNamSpace; ?>.RefPanels && <?php echo $this->JSPanelNamSpace; ?>.RefPanels != "") {
                                // alert(da.AlgCatTree.DetailPanels);
                                da.RefreshDetailPanels(<?php echo $this->JSPanelNamSpace; ?>.RefPanels, "SetAlg", <?php echo $this->JSPanelNamSpace; ?>
                                    .Get());
                            }
                            da.UsrMsgShow('<?php echo $_SESSION["SuccessMsg"]; ?>', "Info");
                        } else {
...
$(document).ready(function() {
    ...
    $("#<?php echo $this->PanelTag; ?>fileRefProc").keyup(function(event) {
        <?php echo $this->JSPanelNamSpace; ?>.btnControl();
    });
    $("#<?php echo $this->PanelTag; ?>IdAlgState").change(function(event) {
