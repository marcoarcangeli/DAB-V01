...
$UIP = new UIP();
// print_r(json_encode($UIP->ReadProxy($CompulsoryParamNams,$_GET)));
if($_SESSION["Debug"]>=2){ LM::LogMessage("DEBUG",__CLASS__."->". __FUNCTION__." - json_encode(_POST): ".json_encode($_POST)); }

print_r(json_encode($UIP->ReadProxy($CompulsoryParamNams,$_POST)));
